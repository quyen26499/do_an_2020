...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_job,admin_contact,admin_country,admin_image,admin_about) values ('$user_name','$user_email','$user_pass','$user_job','$user_contact','$user_country','$user_image','$user_about')";
    
    $run_user = mysqli_query($con,$insert_user);
    
    if($run_user){
        
        echo "<script>alert('New User has been inserted to your admin successfully')</script>";
